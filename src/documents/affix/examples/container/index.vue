<template>
	<Example id="example-affix-container">
...
<style>
	...
	.example-affix-container-content { height:400px; background:transparent url("~@/assets/images/transparent.png") repeat 50% 50%; padding:40px 0; }
</style>