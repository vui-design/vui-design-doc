<template>
	<Example vertical id="example-button-type">
		...
		<template slot="title">按钮类型</template>
...
<style>
	...
	.example-button-type > section > .vui-button > svg { width:14px; vertical-align:-0.125em; fill:currentColor; margin-right:5px; }
</style>