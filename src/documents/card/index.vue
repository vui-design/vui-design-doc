...
<script>
	...
	import ExampleCardShadow from "./examples/shadow";
	import ExampleCardLoading from "./examples/loading";
	import ExampleCardGrid from "./examples/grid";
	import ExampleCardFlexibleContent from "./examples/flexible-content";
