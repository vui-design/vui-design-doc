<template>
	<Example id="example-layout-header-sider-first">
		<template slot="source">
			<Browser>
				<vui-layout>
					...
					<vui-content style="padding: 0 50px;">
						...
						<vui-layout>
							<vui-sider :width="200">
								<vui-menu mode="inline" :openNames="['1']" :selectedName="'1-1'" style="min-height: 100%; border-right: 1px solid #ececec;">
