<template>
	<Example id="example-table-export">
		...
		<template slot="describe">
			<p>通过调用表格 <code>download()</code> 方法，可以将数据导出为 <code>csv</code> 格式的表格文件。<a href="javascript:;">详见下文 API 说明</a>。</p>
			<p>注意</p>
