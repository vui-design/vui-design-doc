<template>
	<Example vertical id="example-tooltip-colorful">
		<template slot="source">
			<div>
				...
				<div class="example-tooltip-colorful">
					<h4>Custom</h4>
					<vui-tooltip color="#f50" content="This is a tooltip">
						<vui-button>#f50</vui-button>
					</vui-tooltip>
		...
		<template slot="title">多彩文字提示</template>
