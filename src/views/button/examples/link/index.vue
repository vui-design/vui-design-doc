<template>
  <vui-doc-example v-bind:code="code" id="example-button-link">
    <template slot="demo">
    ...
    <template slot="title">链接按钮</template>
    <template slot="description">
      <p>属性 <code>href</code> 用于设置按钮点击后的跳转地址，指定此属性后按钮的点击行为将和普通 <code>a</code> 链接保持一致。</p>
