<template>
	<vui-doc-example v-bind:code="code" id="example-cell-other">
		<template slot="demo">
		...
		<template slot="title">其他用法</template>
		<template slot="description">
			<p>设置 <code>selected</code> 或 <code>disabled</code> 属性可以选中或禁用单元格。</p>
			<p>您还可以结合其他组件一起使用，较为灵活。</p>
		</template>
	</vui-doc-example>
</template>
