<template>
	<vui-doc-example v-bind:code="code" id="example-select-max-tag-count">
		<template slot="demo">
		...
		<template slot="title">最多显示数量</template>
		<template slot="description">
			<p>属性 <code>maxTagCount</code> 用于指定最多显示多少个 <code>tag</code> 标签，超出的部分折叠。</p>
		</template>
	</vui-doc-example>
</template>
