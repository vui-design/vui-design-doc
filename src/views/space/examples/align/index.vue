<template>
  <vui-doc-example v-bind:code="code" id="example-space-align">
    <template slot="demo">
    ...
    <template slot="title">交叉轴对齐方式</template>
...
<style>
  ...
  .example-space-align-block + .example-space-align-block { margin-top:16px; }
</style>