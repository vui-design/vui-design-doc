<template>
	<div>
		...
		<vui-doc-markdown>
			...
			<p>以上方法隐式的创建及维护组件，参数 <code>options</code> 可以是字符串或对象。当为字符串时，仅仅表示消息文案；当为对象时，具体说明如下：</p>
			<table class="example-api-props">
				<thead>
					<tr>
						<th width="80">属性</th>
			...
			<p>以上方法调用后，会返回一个引用，可以通过该引用取消对应的 <code>Spin</code> 组件的加载状态，详见上述示例。</p>
			<ul>
...
<script>
	...
	import ExampleSpinNested from "./examples/nested";
	import ExampleSpinDelay from "./examples/delay";
	import ExampleSpinIndicator from "./examples/indicator";
	import ExampleSpinMessage from "./examples/message";
	import ExampleSpinFullscreen from "./examples/fullscreen";
