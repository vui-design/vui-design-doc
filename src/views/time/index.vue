    ...
    <document>
      ...
      <table class="example-api-props">
        ...
        <tbody>
          <tr>
            <td>type</td>
            <td>显示类型，可选值为 <code>relative</code>、<code>date</code>、<code>datetime</code> 或者不设</td>
            <td>String</td>
            <td>relative</td>
          </tr>
          <tr>
            <td>value</td>
            <td>需要对比的时间，可以是日期字符串、时间戳或 <code>Date</code> 对象</td>
...
<script>
  ...
  import ExampleInterval from "./examples/interval";
