<template>
	<example v-bind:code="code" id="example-timeline-pending">
		<template slot="demo">
			<div class="example-timeline-pending">
		...
		<template slot="title">幽灵节点</template>
		<template slot="description">
			<p>通过 <code>pending</code> 属性来标记最后一个为幽灵节点，表示还未完成。</p>
		</template>
	</example>
</template>
