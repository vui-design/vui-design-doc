    ...
    <document>
      ...
      <table class="example-api-props">
        ...
        <tbody>
          ...
          <tr>
            <td>beforeUpload</td>
            <td>上传文件之前的钩子函数，接收 <code>file</code>、<code>list</code> 作为参数<br />若该钩子函数返回 <code>false</code> 则禁止上传；支持返回一个 <code>Promise</code> 对象，<code>Promise</code> 对象 <code>resolve</code> 时允许上传，<code>reject</code> 时禁止上传</td>
            <td>Function</td>
            <td>--</td>
          </tr>
          <tr>
            <td>beforeRemove</td>
            <td>删除文件之前的钩子函数，接收 <code>file</code>、<code>list</code> 作为参数<br />若该钩子函数返回 <code>false</code> 则禁止删除；支持返回一个 <code>Promise</code> 对象，<code>Promise</code> 对象 <code>resolve</code> 时允许删除，<code>reject</code> 时禁止删除</td>
            <td>Function</td>
            <td>--</td>
          </tr>
          <tr>
      ...
      <table class="example-api-events">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>文件上传时的事件回调函数</td>
            <td>Function</td>
            <td>progress, file, list</td>
          </tr>
          <tr>
            <td>success</td>
            <td>文件上传成功的事件回调函数</td>
            <td>Function</td>
            <td>response, file, list</td>
          </tr>
          <tr>
            <td>error</td>
            <td>文件上传失败的事件回调函数</td>
            <td>Function</td>
            <td>error, file, list</td>
          </tr>
          <tr>
            <td>preview</td>
            <td>点击预览按钮的事件回调函数</td>
          ...
          <tr>
            <td>change</td>
            <td>文件状态发生变化时的事件回调函数，添加文件、上传中/成功/失败、删除文件时都会被调用</td>
            <td>Function</td>
            <td>file, list</td>
          </tr>
        </tbody>
...
<script>
  ...
  import ExamplePicture from "./examples/picture";
  import ExamplePictureCard from "./examples/picture-card";
  import ExampleDraggable from "./examples/draggable";
  import ExampleList from "./examples/list";
  import ExampleAvatar from "./examples/avatar";
  import ExampleManually from "./examples/manually";
