<template>
  <div>
    <vui-doc-markdown>
      ...
      <p>使用 <code>vue-cli 3</code> 构建应用时，默认情况下 <code>babel-loader</code> 会忽略所有 <code>node_modules</code> 中的文件。因此，在利用按需加载的方式引入 Vui Design 组件时，需要配置 <code>Babel</code> 显式转译其中的依赖，可以在 <code>vue.config.js</code> 文件中进行设置：</p>
...
<script>
  ...
  import ExampleVueCli3VueConfig from "./examples/vue-config";
