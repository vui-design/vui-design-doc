<template>
  <vui-doc-example v-bind:code="code" id="example-watermark-size">
    <template slot="demo">
      <vui-watermark v-bind:width="200" v-bind:height="120" text="zhangsan 张三">
    ...
    <template slot="title">画布尺寸</template>
    <template slot="description">
      <p>自定义单个水印的画布尺寸，尺寸越小，水印越密集。</p>
    </template>
  </vui-doc-example>
</template>
